...
export const FORM_COPY = {
  en: {
    ...
    whatsappOptIn: "I agree to receive a WhatsApp message from DC Project about this request",
    submit: "Get a quote",
    sending: "Sending…",
    success:
  ...
  ru: {
    ...
    whatsappOptIn: "Я согласен(на) получить сообщение в WhatsApp от DC Project по этой заявке",
  ...
  he: {
    ...
    whatsappOptIn: "אני מסכים/ה לקבל הודעת וואטסאפ מ-DC Project בנוגע לפנייה הזו",
